<!-- Link Slide -->
<h1 class="form_title">
    <span id="link_login">Accedi</span>
    <span id="link_register">Registrati</span>
</h1>
...
<section class="form_login" id="form_login"> 
    <form>
        ...
        <input class="form_input_email" name="email" type="email" placeholder="Email" minlength="5" maxlength="50" autofocus required>
        ...
        <div class="form_label">
            <label class="form_checkbox_label">
                ...
                <span class="form_checkbox_custom"></span>
            </label>
            <label class="form_checkbox_p" for="remember">Ricordami</label>
        </div>
        <div id="login" class="form_input_submit">Accedi</div>
     </form>
</section>

<!-- Form Registrazione -->
<section class="form_register" id="form_register"> 
    <form>
        <div class="email_err"></div>
        <input class="form_input_email" name="emailr" type="email" placeholder="Email" minlength="5" maxlength="50" autofocus required>
        <div class="password_err"></div>
        <div class="form_eye">
            <div class="form_eye_icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="21" viewBox="0 0 36 21" fill="none">
            ...
            <input class="form_input_password" name="passwordr" type="password" placeholder="Password" pattern="[a-zA-z0-9]{5,20}" minlength="5" maxlength="20" required>
        </div>
        <div class="passwordconf_err"></div>
        <div class="form_eye">
            <div class="form_eye_icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="21" viewBox="0 0 36 21" fill="none">
                    <path d="M35.8661 10.074C35.5826 9.66149 28.7696 0 17.9996 0C8.7581 0 0.523107 9.60601 0.176607 10.0155C-0.0588691 10.2945 -0.0588691 10.704 0.176607 10.9845C0.523107 11.394 8.7581 21 17.9996 21C27.2411 21 35.476 11.394 35.8225 10.9845C36.0401 10.7265 36.0596 10.353 35.8661 10.074ZM17.9996 19.5C10.5911 19.5 3.5471 12.435 1.75765 10.5C3.54415 8.56356 10.5807 1.50005 17.9996 1.50005C26.6681 1.50005 32.7866 8.55456 34.2806 10.4595C32.5555 12.333 25.4711 19.5 17.9996 19.5Z" fill="#666"/>
            ...
            <input class="form_input_password" name="passwordconf" type="password" placeholder="Conferma Password" pattern="[a-zA-z0-9]{5,20}" minlength="5" maxlength="20" required>
        </div>
        <div class="terms_err"></div>
        <div class="form_label">
            <label class="form_checkbox_label">
                <input type="checkbox" name="terms" id="terms">
                <span class="form_checkbox_custom"></span>
            </label>
            <label class="form_checkbox_p" for="terms">* Accetto tutti i termini e le condizioni</label>
        </div>
        <div id="register" class="form_input_submit">Registrati</div>
    </form>
</section>