<!-- Titolo -->
<h1 id="link_password" class="form_title">Cambia Password</h1>

<!-- Form Cambio Password -->
<section class="form_passwordchange"> 
    <form>
        ...
        <div class="form_eye">
            ...
            <input class="form_input_password" name="password" type="password" placeholder="Nuova Password" pattern="[a-zA-z0-9]{5,20}" minlength="5" maxlength="20" autofocus required>
        </div>
        ...
        <div class="form_eye">
            ...
            <input class="form_input_password" name="passwordold" type="password" placeholder="Vecchia Password" pattern="[a-zA-z0-9]{5,20}" minlength="5" maxlength="20" required>
        </div>
        <div id="passwordchange" class="form_input_submit">Conferma</div>
    </form>
</section>